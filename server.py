...
ENGINE = Renderer()
ROUTES = {
    "/render": lambda payload: {"html": ENGINE.render(payload["template"], payload.get("context", {}),
                                                      payload.get("partials", {}), payload.get("name", "inline"))},
    "/check": lambda payload: ENGINE.check(payload["template"], payload.get("name", "inline")),
